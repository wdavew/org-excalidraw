...
(describe
  "link formatting"
  :var ((excal-path "home/excalidraw drawings/my-drawing.excalidraw")
        (bad-path "home/excalidraw drawings/my-drawing.txt"))
  (message (org-excalidraw-format-link excal-path))
  (it "formats the open command for macOS"
    (expect (org-excalidraw-format-link excal-path)
            :to-equal
            "[[excalidraw:home/excalidraw drawings/my-drawing.excalidraw.svg]]"))

  (it "requires .excalidraw extension"
    (expect (org-excalidraw-format-link bad-path) :to-throw)))

(describe
  "checks external dependencies on initialization"
  (it "requires excalidraw directory to exist"
    (spy-on :f-dir? :and-return-value nil)
